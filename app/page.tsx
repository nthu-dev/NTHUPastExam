...
const footerNavigation = {
    ...
    support: [],
    company: [
        {name: '清資社', href: 'https://nthu.dev'},
    ],
    legal: [],
    social: [
        {
            name: 'Facebook',
            href: 'https://facebook.com/nthu.pastexam',
            icon: (props: any) => (
                ...
                <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
                    <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                        ...
                        <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
                            ...
                            {/*            {footerNavigation.solutions.length > 0 && footerNavigation.solutions.map((item) => (*/}
                            {/*                <li key={item.name}>*/}
                            {/*                    <a href={item.href}*/}
                            ...
                            {/*        <ul role="list" className="mt-6 space-y-4">*/}
                            {/*            {footerNavigation.support.length > 0 && footerNavigation.support.map((item) => (*/}
                            {/*                <li key={item.name}>*/}
                            {/*                    <a href={item.href}*/}
                            {/*                       className="text-sm leading-6 text-gray-300 hover:text-white">*/}
                            {/*                        {item.name}*/}
                            ...
                            <div className="md:grid md:grid-cols-2 md:gap-8">
                                <div>
                                    ...
                                    <ul role="list" className="mt-6 space-y-4">
                                        {footerNavigation.company.length > 0 && footerNavigation.company.map((item) => (
                                            <li key={item.name}>
                                                <a href={item.href}
                                                   className="text-sm leading-6 text-gray-300 hover:text-white">
                                                    {item.name}
                                ...
                                {/*    <ul role="list" className="mt-6 space-y-4">*/}
                                {/*        {footerNavigation.legal.length > 0 && footerNavigation.legal.map((item) => (*/}
                                {/*            <li key={item.name}>*/}
                                {/*                <a href={item.href}*/}
                                {/*                   className="text-sm leading-6 text-gray-300 hover:text-white">*/}
                                {/*                    {item.name}*/}
                    ...
                    <div className="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
                        ...
                        <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
                            &copy; { new Date().getFullYear() } 清大考古題系統. All rights reserved.
                        </p>
                    </div>
                </div>
            </footer>
